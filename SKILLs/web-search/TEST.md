...
This guide walks through testing the entire Web Search Skill integration with SuiXinAI.

## Prerequisites

1. SuiXinAI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with SuiXinAI.

**Steps:**

1. Start SuiXinAI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of SuiXinAI launch.
...
1. Open a terminal while SuiXinAI is running
...
**Objective:** Verify graceful shutdown of services when SuiXinAI quits.

**Steps:**

1. With SuiXinAI running and searches completed, quit the application
...
1. Start SuiXinAI (ensure headless is false in config)
...
- ✅ Server auto-starts with SuiXinAI
