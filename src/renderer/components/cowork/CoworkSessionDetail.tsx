...
const buildRailItems = (
  ...
  for (let index = 0; index < turns.length; index += 1) {
    ...
    items.push({
      ...
      label: turn.userMessage ? getRailLabel(userContent, `Turn ${index + 1}`) : '随心 AI',
      summary: assistantContent
        ? getRailLabel(assistantContent, '随心 AI', COWORK_RAIL_TOOLTIP_PREVIEW_MAX_LENGTH)
        : '',
...
const composeExportCanvas = async (
  ...
  ctx.fillText('随心 AI — 全场景个人助理 Agent', textX, footerCenterY - taglineFontSize / 2 - 2);
