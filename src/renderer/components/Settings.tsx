...
import { getVisibleSettingsTabKeys, type SettingsTabKey, usesSettingsGlobalSave } from './settingsTabUtils';
import EmailSkillConfig from './skills/EmailSkillConfig';
import ThemedSelect from './ui/ThemedSelect';

type TabType = SettingsTabKey;
...
const Settings: React.FC<SettingsProps> = ({
  ...
  const sidebarTabs: { key: TabType; label: string; icon: React.ReactNode }[] = (() => {
    const allTabs = [
      ...
      { key: 'mcp' as TabType,            label: i18nService.t('mcpServers'),     icon: <WrenchScrewdriverIcon className="h-5 w-5" /> },
    ...
    const visibleTabKeys = new Set(getVisibleSettingsTabKeys(enterpriseConfig));
  ...
  const showGlobalSaveActions = usesSettingsGlobalSave(activeTab);
      ...
      case 'about':
        return (
          <div className="flex min-h-full flex-col items-center pt-6 pb-3">
            ...
            />
            <h3 className="text-lg font-semibold text-foreground">随心 AI</h3>
    ...
    >
      ...
      >
        ...
        <div className="relative flex-1 flex flex-col min-w-0 overflow-hidden bg-background rounded-r-2xl">
          ...
          <form
            onSubmit={showGlobalSaveActions ? handleSubmit : (event) => event.preventDefault()}
