...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    login: '登录',
    inDevelopment: '正在开发中',
    authEmailLoginTitle: '登录',
    authEmailLoginSubtitle: '我们将向您的邮箱发送验证码进行登录',
    authEmailLoginEmailLabel: '邮箱地址',
    authEmailLoginSendCode: '发送验证码',
    authEmailLoginSendingCode: '发送中...',
    authEmailLoginCodeHint: '请输入 6 位验证码',
    authEmailLoginCodeSentTo: '验证码已发送至：{email}',
    authEmailLoginResendIn: '{seconds}秒后可重新发送',
    authEmailLoginResend: '重新发送',
    authEmailLoginBack: '返回',
    authEmailLoginInvalidEmail: '请输入有效的邮箱地址',
    authEmailLoginRequestCodeFailed: '验证码发送失败，请稍后重试',
    authEmailLoginVerifyFailed: '验证码校验失败，请重试',
    authEmailLoginAgreement: '登录即表示您同意我们的服务条款和隐私政策',
    ...
    shortcutDescNewChat: '开始一个新的随心 AI 任务',
    shortcutDescFocusPrompt: '跳回随心 AI 并聚焦当前输入框',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录随心 AI Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: '随心 AI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为随心 AI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义随心 AI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: '随心 AI 使用模型设置中的当前模型与提供商配置。',
    ...
    openClawDataBackupBlockingTitle: '正在备份随心 AI 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入随心 AI 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入随心 AI 数据备份？',
    ...
    coworkConfigSaveFailed: '保存随心 AI 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: '随心 AI 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: '随心 AI 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkSidebarVersionFallback: '桌面版',
    coworkSidebarWorkspaceLabel: '工作台',
    ...
    agentMarketTitle: '模板市场',
    agentMarketSearchPlaceholder: '搜索模板名称或描述',
    agentMarketDivisionAll: '全部',
    agentMarketResultsCount: '共 {count} 个结果',
    agentMarketEmpty: '没有匹配的模板',
    agentMarketInstalled: '已添加',
    ...
    browserWebAccessDescription: '使用随心 AI 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: '随心 AI 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为随心 AI 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: '随心 AI 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着随心 AI 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着随心 AI 可以打开此域名',
    ...
    usageAnalyticsEnabled: '帮助改进随心 AI',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道随心 AI 服务协议',
    privacyDialogDesc: '在使用网易有道随心 AI 之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道随心 AI 服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用随心 AI',
  ...
  en: {
    ...
    authEmailLoginTitle: 'Login',
    authEmailLoginSubtitle: 'We will send a verification code to your email to sign you in',
    authEmailLoginEmailLabel: 'Email address',
    authEmailLoginSendCode: 'Send code',
    authEmailLoginSendingCode: 'Sending...',
    authEmailLoginCodeHint: 'Enter the 6-digit verification code',
    authEmailLoginCodeSentTo: 'Verification code sent to: {email}',
    authEmailLoginResendIn: 'Resend available in {seconds}s',
    authEmailLoginResend: 'Resend code',
    authEmailLoginBack: 'Back',
    authEmailLoginInvalidEmail: 'Please enter a valid email address',
    authEmailLoginRequestCodeFailed: 'Failed to send the verification code. Please try again.',
    authEmailLoginVerifyFailed: 'Failed to verify the code. Please try again.',
    authEmailLoginAgreement: 'By logging in, you agree to our Terms of Service and Privacy Policy',
    ...
    shortcutScopeHint: 'Shortcuts only run while the 随心 AI window is focused; global shortcuts are ignored while editing text fields.',
    ...
    shortcutDescNewChat: 'Start a new 随心 AI task',
    shortcutDescFocusPrompt: 'Return to 随心 AI and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the 随心 AI task view',
    ...
    shortcutDescOpenMcp: 'Open the MCP settings tab',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit 随心 AI Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    artifactPreviewCardLobsterBrowser: '随心 AI Browser',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in 随心 AI Browser',
    ...
    coworkPlaceholder: 'What would you like SuiXin AI to handle today? Start with a task, a question, or a referenced file',
    coworkWorkingDirectory: 'Working Directory',
    coworkWorkingDirectoryPlaceholder: 'Enter project path',
    coworkWorkingDirectoryHint: '随心 AI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for 随心 AI...',
    coworkSystemPromptHint: "Optional system prompt to customize 随心 AI's behavior",
    ...
    coworkModelSettingsHint:
      '随心 AI uses the current model and provider configuration from Model Settings.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up 随心 AI data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import 随心 AI data',
    ...
    openClawDataMigrationConfirmTitle: 'Import 随心 AI data backup?',
    ...
    coworkConfigSaveFailed: 'Failed to save 随心 AI settings. Please try again.',
    ...
    coworkPermissionDescription: '随心 AI is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: '随心 AI needs your input',
    ...
    coworkWelcome: '随心 AI',
    coworkDescription: 'Your workday',
    coworkHeroHeadline: 'superpower',
    coworkSidebarVersionFallback: 'Desktop',
    coworkSidebarWorkspaceLabel: 'Workspace',
    ...
    agentMarketTitle: 'Template Market',
    agentMarketSearchPlaceholder: 'Search template name or description',
    agentMarketDivisionAll: 'All',
    agentMarketResultsCount: '{count} results',
    agentMarketEmpty: 'No matching templates',
    agentMarketInstalled: 'Added',
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add 随心 AI to your antivirus allowlist.',
    ...
    browserWebAccessDescription: 'Use the 随心 AI separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: '随心 AI starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for 随心 AI, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: '随心 AI will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means 随心 AI will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means 随心 AI can open this domain',
    ...
    usageAnalyticsEnabled: 'Help improve 随心 AI',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao 随心 AI Terms of Service',
    privacyDialogDesc:
      'Before using NetEase Youdao 随心 AI, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao 随心 AI Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to 随心 AI',
