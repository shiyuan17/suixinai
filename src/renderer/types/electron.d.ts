...
interface IElectronAPI {
  ...
  auth: {
    ...
    verifyEmailCode: (payload: { email: string; code: string }) => Promise<{
      success: boolean;
      user?: any;
      quota?: any;
      error?: string;
  ...
  auth: {
    ...
    verifyEmailCode: (payload: { email: string; code: string }) => Promise<{
      ...
      authMode?: 'local_supabase' | 'remote';
      error?: string;
    }>;
    ...
    logout: () => Promise<{ success: boolean }>;
    refreshToken: () => Promise<{ success: boolean; accessToken?: string; authMode?: 'local_supabase' | 'remote' }>;
    getAccessToken: () => Promise<string | null>;
    getPendingCallback: () => Promise<string | null>;
    onCallback: (callback: (data: { code: string }) => void) => () => void;
  };
