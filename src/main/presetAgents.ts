...
import { AGENCY_AGENTS_ZH_PRESET_AGENTS } from './generated/agencyPresetAgents';
...
export type PresetAgentOrigin = typeof PresetAgentOrigin[keyof typeof PresetAgentOrigin];
...
export const PRESET_AGENTS: PresetAgent[] = [
  {
    ...
    division: 'built-in',
    divisionLabel: '内置',
    divisionLabelEn: 'Built-in',
    origin: PresetAgentOrigin.BuiltIn,
  },
  {
    id: 'content-writer',
    name: '内容创作',
...
export const ALL_PRESET_AGENTS: PresetAgent[] = [
  ...PRESET_AGENTS,
  ...AGENCY_AGENTS_ZH_PRESET_AGENTS,
];
