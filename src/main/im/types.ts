...
export interface WhatsAppOpenClawConfig {
  enabled: boolean;
  webhookHost: string;
  webhookPort: number;
  webhookSecret: string;
  listenerBaseUrl: string;
  sendEndpointPath: string;
...
export interface IMGatewayConfig {
  ...
  whatsapp: WhatsAppOpenClawConfig;
...
export const DEFAULT_WHATSAPP_OPENCLAW_CONFIG: WhatsAppOpenClawConfig = {
  enabled: false,
  webhookHost: '127.0.0.1',
  webhookPort: 3190,
  webhookSecret: '',
  listenerBaseUrl: 'http://127.0.0.1:3031',
  sendEndpointPath: '/whatsapp/send',
...
export const DEFAULT_IM_CONFIG: IMGatewayConfig = {
  ...
  whatsapp: DEFAULT_WHATSAPP_OPENCLAW_CONFIG,
